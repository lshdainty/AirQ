...
<div class="re_container">
	...
	<img src="resources/images/room.png" alt="">
	<div class="imgup">
		
		<input type="text" id="nickname" placeholder="자신만의 별명을 지어주세요!"
			style="width: 300px;">
		...
		<div class="select_reg">
			<div class="column-6 form-select">
				<select id="selid" name="id">
					<option selected>제어 기기 종류</option>
			...
			<div class="column-7 form-select">
				<select id="selid2" name="id">
					<option selected>제어 기기 위치</option>
