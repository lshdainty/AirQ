...
<div class="container">
	...
	<form id="form1">
		<section class="content">
			...
			<%-- 하단부분 시작 --%> <c:forEach var="ReplyN" items="${ReplyN}">
				<div class="form2">
					<c:choose>
			...
			</c:forEach> <%-- 하단부분 시작 --%> <c:forEach var="ReplyN" items="${ReplyN}">
				<div class="form2">
					<c:choose>
						<c:when test="${ReplyN.board_name ne null }">
							<div class="board">${ReplyN.board_name }</div>
			...
			</c:forEach> <c:forEach var="ReplyNPost" items="${ReplyNPost}">
				<div class="form3">
			...
			</c:forEach> <c:forEach var="ReplyNProduct" items="${ReplyNProduct}">
				<div class="form4">
					<div class="board">업체 분석/비교</div>
