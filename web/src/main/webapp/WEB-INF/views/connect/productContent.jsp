...
<main class="site_main view miw1180">
        <section class="viewdetail clear">
            ...
            <div class="imgs on_w">
                <div class="visual">
                	<a href="#largeviewLayer" data-type="largeviewlayer" class="custom_cursor">
                		<img alt="" src="resources/uploadFile/images/${productContent.file_name}" />
                	</a>
                </div>
            </div>
            <div class="info"><a class="brand ellipsis tc_1">${productContent.companyVO.company_name}</a>
                ...
                <dl class="price clear">
                    ...
                    <dd> <strong class="" style="white-space: nowrap;">
                    ...
                    <dd> <strong class="">${productContent.sellnum}개</strong></dd>
                    <dt class="final">만족도평균</dt>
                    <dd> <strong class="">${productContent.staravg}점</strong></dd>
                </dl>
                <dl class="price lc_e5 clear">
                        <dt class="final">상품가격</dt>
                        <dd> <strong class="now tc_3">${productContent.product_price}원</strong></dd>
                </dl>
                <div class="on_w">
                    ...
                    <div class="btns clear"><button type="button" id="paymentButton" class="btn_add large">구매하기</button> <button
                            type="button" id="reportButton" class="btn_buy dark large">신고하기</button></div>
                    <ul class="links tc_8"></ul>
                </div>
            </div>
        </section>
