...
<div class="compare-wrap">
			...
			<c:forEach var="recommend" items="${recommend}">
				<div class="compare-recommand__post" id="${recommend.product_code}">
					...
					<div class="recommanded-title">
						<span>${recommend.product_name}</span>
					</div>
				</div>
			</c:forEach>
		</div>
	...
	<div class="order-address">
		...
		</select> <select name="sigoon_code" id="sigoon_code" class="order-option">
			<option value="선택">선택</option>
		</select> <select name="space" id="space" class="order-option">
		...
		</select> <select name="matter" id="matter" class="order-option">
			...
			<div class="compare-post_grid post-item" id="${pList.product_code}">
				...
				<div class="compare-info_grid">
					...
					<div class="compare__price">
						<span>${pList.product_price}</span>원
					</div>
				</div>
			</div>
		</c:forEach>
