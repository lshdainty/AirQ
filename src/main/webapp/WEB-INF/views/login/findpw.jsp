...
<link rel="stylesheet" type="text/css" href="/resources/css/login/findpw.css"/>
    ...
    <div class="container">
        ...
        <section class="content">
            <main>
            		<%-- 등록된 이름+  전화번호 or 이메일로  pw 찾기 시작 --%>
                    <div class="login-form">
                            <div class="form-group">

                                <input type="text" id="name"class="form-control-1" placeholder="User Name">
                                <br>
                                <input type="text" id="id"class="form-control-1" placeholder="User ID">
                                <br>
                                ...
                                <input type="text" id="email"class="form-control-1" placeholder="e-mail">
                                <br>
                            </div>
                            <button type="submit" id="findpwtest"class="btn btn-login">확인</button>
                    </div>
                    <%-- 등록된 이름+  전화번호 or 이메일로  pw 찾기 끝 --%>
            </main>
            <nav>
