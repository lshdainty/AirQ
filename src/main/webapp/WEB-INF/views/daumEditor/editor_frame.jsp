...
<DIV id=tx_trex_container class=tx-editor-container>
					...
					<DIV id=tx_richtextbox_menu class="tx-richtextbox-menu tx-menu">
						...
						<DIV class=tx-menu-footer>
							<IMG class=tx-menu-confirm alt=""
								src=" /resources/daumOpenEditor/images/icon/editor/btn_confirm.gif?rv=1.0.1">
							<IMG class=tx-menu-cancel hspace=3 alt=""
								src=" /resources/daumOpenEditor/images/icon/editor/btn_cancel.gif?rv=1.0.1">
						</DIV>
					</DIV>
				<LI class=tx-list>
	...
	<DIV id=tx_canvas class=tx-canvas>
		<DIV id=tx_loading class=tx-loading>
			<DIV>
				<IMG
					src=" /resources/daumOpenEditor/images/icon/editor/loading2.png"
	...
	<DIV id=tx_resizer class=tx-resize-bar>
		...
		<IMG id=tx_resize_holder alt=""
			src=" /resources/daumOpenEditor/images/icon/editor/skin/01/btn_drag01.gif"
			width=58 height=12 unselectable="on">
	</DIV>
	<DIV id=tx_side_bi class=tx-side-bi>
		<DIV style="TEXT-ALIGN: right">
			<IMG hspace=4
				src=" /resources/daumOpenEditor/images/icon/editor/editor_bi.png"
		...
		<DIV id=tx_attach_box class=tx-attach-box>
			<DIV class=tx-attach-box-inner>
				<DIV id=tx_attach_preview class=tx-attach-preview>
					<P>&nbsp;</P>
					<IMG src="/resources/daumOpenEditor/images/icon/editor/pn_preview.gif" width=147 height=108 unselectable="on">
				</DIV>
