...
<%@include file="../include/header.jsp" %>
        ...
        <div class="full-width full-height">
            <div class="pin-scene">
                <div class="title-main">
                    <p class="top-titles">Develop your AiQuality</p>
                    <h1>AirQ</h1>
                ...
                <div class="dude">
                    <img src="resources/images/tree.png" alt="Dude on a forest">
                </div>
    ...
    <section>
        <div class="section2 full-height">
            <div class="s-inner">
                <img src="resources/images/superman.png" alt="My huge massive tiny small tree" class="superMan">
                <p class="top-titles">Hello there section 2</p>
                <h1>This is section2 of the prallax tutorial</h1>
                <p>Here is the sub blurb that can go here</p>
            </div>
